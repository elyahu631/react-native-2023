    ...
    return (
      <View style={styles.container}>
        <Text style={{ textAlign: "center" }}>
          אנחנו צריכים את רשותכם כדי להראות את המצלמה
        </Text>
    ...
    <View style={styles.container}>
      ...
      {imgSrc && (
        <View>
          ...
          >
            <Button style={styles.btns} onPress={() => setImgSrc("")}>
              צלם תמונה חדשה
            </Button>
            <Button style={styles.btns} onPress={AddToGallery}>
              הוסף לגלרייה
            </Button>
          </View>
        </View>
      ...
      <Snackbar
        ...
        onDismiss={() => {
          setImgSrc(""), setSnackbarVisible(false);
        }}
        duration={3000}
        action={{
          onPress: () => {
...
const styles = StyleSheet.create({
  ...
  camera: {
    width: windowWidth - 70,
    height: (windowWidth / windowHeight) * windowWidth * 2,
